...
export type ApiErrorCode = "EVENT_NOT_FOUND" | "INVALID_INPUT" | "INVALID_GUEST" | "INVALID_CURSOR" | "UPLOAD_DISABLED" | "GALLERY_DISABLED" | "UNAUTHORIZED" | "PAYLOAD_TOO_LARGE" | "CSRF_REJECTED" | "INVALID_CLOUDINARY_ASSET" | "CLOUDINARY_ERROR" | "DATABASE_ERROR" | "INTERNAL_ERROR";
