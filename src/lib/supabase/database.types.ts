...
export type Database = {
  public: {
    Tables: {
      ...
      guests: {
        Row: { id: string; event_id: string; nickname: string; avatar_key: import("@/features/guests/avatars").AvatarId; created_at: string };
        Insert: { id?: string; event_id: string; nickname: string; avatar_key?: import("@/features/guests/avatars").AvatarId; created_at?: string };
      ...
      guest_awards: {
        ...
        Relationships: [
          ...
          { foreignKeyName: "guest_awards_guest_event_fkey"; columns: ["guest_id", "event_id"]; isOneToOne: false; referencedRelation: "guests"; referencedColumns: ["id", "event_id"] },
        ];
      };
    };
    ...
    Functions: {
      list_public_photos_with_likes: {
        ...
        Returns: Array<{ id: string; post_id: string; post_created_at: string; group_position: number; mock_image_url: string | null; cloudinary_public_id: string | null; width: number | null; height: number | null; caption: string | null; created_at: string; guest_id: string; guest_nickname: string; like_count: number; liked_by_current_guest: boolean; guest_avatar_key: import("@/features/guests/avatars").AvatarId }>;
      };
      list_public_photos_with_likes_without_avatar: {
        Args: { target_event_id: string; target_guest_id?: string | null; target_current_guest_id?: string | null; sort_order?: string; page_limit?: number; cursor_created_at?: string | null; cursor_id?: string | null };
